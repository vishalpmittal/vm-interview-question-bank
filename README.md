...
A personal collection of interview questions across technical and leadership domains, organized by category.
...
- A `README.md` describing the category, suggested topics, and file conventions
- One or more `.md` files containing the actual questions, grouped by sub-topic or competency
